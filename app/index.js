...
async function getWeather(e) {
    ...
    const city = document.getElementById("searchCity").value.trim(); // Trim whitespace
    console.log(city);
...
async function searchHistory(citySearched) { 
    ...
    citySearched.map((city) => {
        ...
        listItem.className = 'bg-white w-full p-5 text-center rounded-lg cursor-pointer hover:shadow-md active:scale-95 mb-5 text-gray-800 text-4xl list-none';
